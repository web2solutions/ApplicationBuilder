var ApplicationBuilder = {
	...
	,_loadDependencies : function( c, callBack ){
		var dependencies = [
			/*
				lets load jquery first and avoid conflicts on DHTMLX
			*/
			...
			,c.base_path + "ApplicationBuilder/lib/controller/ApplicationBuilder.Rules.js"
			,c.base_path + "ApplicationBuilder/lib/controller/ApplicationBuilder.FormInformation.js"
