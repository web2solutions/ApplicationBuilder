ApplicationBuilder.Designer.view = {
	...
	,_layout : function(){
		var that = ApplicationBuilder, self = ApplicationBuilder.Designer.view;
		self.layout = self.tabbar.cells("ApplicationBuilder.Designer.view").attachLayout(that.settings.Designer.layout);
	...
	,_loadDependencies : function( callBack ){
		...
		var dependencies = [
			...
			,that.settings.application_path + "lib/view/ApplicationBuilder.FormInformation.view.js"
		];
